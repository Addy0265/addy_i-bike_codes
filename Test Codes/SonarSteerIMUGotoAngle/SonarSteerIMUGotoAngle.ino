...
{ 
  ...
  {   
     // Returning Back
     if(returnFlag == 1 && abs(currentAngle) < ANGLE_LIMIT-LIMIT1 && cycle == 0 && currentAngle < 0)
       { 
         changeAngle(-1);
         //Serial.println("HERE");
       }
     else if(returnFlag == 2 && abs(currentAngle) < ANGLE_LIMIT-LIMIT1 && cycle == 0 && currentAngle > 0)
       {
         changeAngle(1);
       }
     else if(cycle == 0)
